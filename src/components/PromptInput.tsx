    ...
    <div className="relative border border-[#cad5e2] shadow rounded-lg p-3">
      ...
      <div className="flex flex-row justify-between gap-4">
        ...
        <div className="flex flex-row gap-2">
          {uploadedFile && (
            <div
              className="flex flex-row items-center justify-center min-w-[128px] relative overflow-hidden gap-1.5 px-2 py-1.5 rounded-sm max-h-[28px] bg-slate-100 border-[0.5px] border-[#90a1b9] md:px-4 md:py-3.5"
